...
/**
 * <p>
 * Java class for Afiliado complex type.
 * 
 * <p>
...
public class Afiliado implements Serializable {
	 ...
	 * for the resolucion2309 property.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Resolucion }
	 * 
	 * 
	 */
	 ...
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the resolucion2280 property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the resolucion4023 property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
